...
export const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: "3.0.3",
    info: {
      title: "ResponderX — Audit Service",
      version: "1.0.0",
      description:
        "The single authoritative audit-log store's read API — every write happens via each service's own transactional outbox delivered here, not through this HTTP surface.",
    },
