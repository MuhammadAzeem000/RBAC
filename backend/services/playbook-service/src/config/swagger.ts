...
export const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: "3.0.3",
    info: {
      title: "ResponderX — Playbook Service",
      version: "1.0.0",
      description:
        "Playbook catalog, the Playbook Designer's authoring API, Temporal-based orchestration (playbook runs), and approval gates. Every endpoint is tenant-scoped by the caller's JWT.",
    },
