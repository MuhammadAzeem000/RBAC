...
// the broker has actually accepted the message. If the broker is
// unreachable, this just keeps retrying in the background; outbox rows
// stay unpublished (durable in this service's own database) until it
// reconnects.
 ...
 * one instance of this worker at once, since two workers racing this query
