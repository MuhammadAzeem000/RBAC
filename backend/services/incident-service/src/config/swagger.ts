...
export const swaggerSpec = swaggerJsdoc({
  definition: {
    openapi: "3.0.3",
    info: {
      title: "ResponderX — Incident Service",
      version: "1.0.0",
      description:
        "Incident CRUD, comments, timeline events, and the incident-creation saga's consumer side. Every endpoint (except the machine-to-machine timeline-write route) is tenant-scoped by the caller's JWT.",
    },
